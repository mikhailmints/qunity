...
let test_typedef () =
  ...
  let dm = update_defmap_with_def dm_empty def in
    ...
    Alcotest.(check bool)
      "typedef in defs" true
      (StringMap.mem "MyType" dm.defs)
...
let test_typedef_variant () =
  ...
  let dm = update_defmap_with_def dm_empty def in
    ...
    Alcotest.(check bool)
      "typedef_variant in defs" true
      (StringMap.mem "MyVariant" dm.defs);
    Alcotest.(check bool)
      "constructor A in constructors" true
      (StringMap.mem "A" dm.constructors);
    Alcotest.(check bool)
      "constructor B in constructors" true
      (StringMap.mem "B" dm.constructors)
...
let test_exprdef () =
  ...
  let dm = update_defmap_with_def dm_empty def in
    ...
    Alcotest.(check bool)
      "exprdef in defs" true
      (StringMap.mem "myExpr" dm.defs)
...
let test_progdef () =
  ...
  let dm = update_defmap_with_def dm_empty def in
    ...
    Alcotest.(check bool)
      "progdef in defs" true
      (StringMap.mem "myProg" dm.defs)
...
let test_realdef () =
  ...
  let dm = update_defmap_with_def dm_empty def in
    ...
    Alcotest.(check bool)
      "realdef in defs" true
      (StringMap.mem "myReal" dm.defs)

let () =
  Alcotest.run "metaprogramming"
    [
